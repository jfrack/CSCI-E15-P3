<head>
	<title>CSCI E-15: P3 - Laravel Basics</title>
	<meta charset="utf-8">
	<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
	<meta name="keywords" content="lorem ipsum random user generator">
	<meta name="description" content="P3 - Developer's Best Friend">
	<!-- Get jquery from CDN -->
